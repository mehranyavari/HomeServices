                    ...
                    <?php foreach ($header_menus as $menu_item):
                        if (!$menu_item->menu_item_parent):
                            ...
                            if (!$has_children):
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"
                                       href="<?= esc_url($menu_item->url); ?>"><?= esc_html($menu_item->title); ?></a>
                                </li>
                            <?php else: ?>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="<?= esc_url($menu_item->url); ?>"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <?php foreach ($child_menu_items as $child_menu_item): ?>
                                            <li><a class="dropdown-item"
                                                   href="<?= esc_url($child_menu_item->url); ?>"><?= esc_html($child_menu_item->title); ?></a>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </li>
